      ...
      >
        ...
        <aside className="col-span-4">
            <div className="border-l-2 border-gray-200 pl-6 space-y-8">
              <div>
                ...
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start">
                    <span className="block w-2 h-2 mt-1.5 mr-3 bg-blue-600 rounded-full flex-shrink-0" />
              ...
              <div>
                <h2 className="text-sm font-bold uppercase tracking-wider text-gray-500 mb-4">Interests</h2>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start">
                    <span className="block w-2 h-2 mt-1.5 mr-3 bg-blue-600 rounded-full flex-shrink-0" />
                    <div className="relative group">
                  ...
                  <li className="flex items-start">
                    ...
                    <div className="relative group">
                      <a 
                        href="mailto:Gustavjerresand@gmail.com?subject=Craft Beer Chat&body=Hey Gustav,%0D%0A%0D%0AI noticed you're into beer! Would love to share some craft beer recommendations or maybe check out a local brewery sometime.%0D%0A%0D%0ACheers"
                        className="hover:text-blue-600 transition-colors duration-200"
                      >
                        Beer
                      </a>
